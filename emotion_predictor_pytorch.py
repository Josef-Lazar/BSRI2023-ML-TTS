...
#eliminate audiofiles whose emotional label is "X", and sort other audiofiles into appropriate partition list
train = []
test1 = []
test2 = []
development = []
...
def test_model(dataloader, model, loss_fn):
    true_positives = [0] * 10 # true positives for each number
    false_positives = [0] * 10 # false positives for each number
    false_negatives = [0] * 10 # false negatives foe each number
    size = len(dataloader.dataset)
